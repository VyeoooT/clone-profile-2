function CardResume({ title, subTitle, description, result }: any) {
    return (
        // card resume
        <div className="w-full h-1/3 flex group">
            {/* dot hover */}
            <div className="relative w-10 h-[6px] bgOpacity mt-16">
                <span className="absolute size-5 rounded-full -top-2 -left-3 flex justify-center items-center bg-black bg-opacity-60">
                    <span className="size-3 rounded-full bg-bodyColor inline-flex group-hover:bg-designColor duration-300"></span>
                </span>
            </div>
            ...
            <div className="w-full bg-black/20 rounded-lg lgl:px-10 p-4 flex flex-col justify-center lgl:gap-10 gap-6 shadowGray hover:bg-opacity-30 duration-300 transition-opacity">
                ...
                <div className="flex lgl:flex-row flex-col justify-between lgl:items-center lgl:gap-0 gap-4 ">
                    ...
                    <div>
                        <p className="px-4 py-2 bg-black/25 text-designColor text-sm font-medium rounded-lg flex justify-center items-center shadowGray">{result}</p>
                    </div>
                </div>
